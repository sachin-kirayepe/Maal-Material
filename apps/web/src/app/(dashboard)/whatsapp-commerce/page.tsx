        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex gap-4">
                  ...
                  <button className="bg-zinc-800 text-white px-6 rounded-xl hover:bg-zinc-700 transition-colors whitespace-nowrap">Change Number</button>
                </div>
              </div>
              ...
              <button className="w-full bg-green-500 text-black py-3 rounded-xl font-medium hover:bg-green-400 transition-colors">
                Save Configurations
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              ...
              <p className="text-3xl font-medium text-white">12,450</p>
              <p className="text-xs text-green-400 mt-2">This month</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <p className="text-sm text-zinc-400 mb-2">Orders via WA</p>
              <p className="text-3xl font-medium text-white">482</p>
              <p className="text-xs text-green-400 mt-2">15% of total orders</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
          ...
          <div className="w-[320px] h-[650px] bg-zinc-900 border-4 border-zinc-800 rounded-[3rem] relative overflow-hidden shadow-2xl">
            ...
            <div className="bg-[#efeae2] h-full p-4 space-y-4">
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.5 }} className="bg-white p-3 rounded-lg rounded-tl-none shadow-sm max-w-[85%] relative border-l-4 border-green-500">
                ...
                <p className="text-sm text-zinc-800 mt-2">Current price is ₹385/bag. Total for 50 bags = ₹19,250.</p>
