...
const navigationItems = [
  { name: "Terminal Overview", href: "/", icon: TerminalSquare, permission: "users:read" },
  ...
  {
    name: "Civilization Command",
    href: "/civilization-command",
    icon: Globe2,
    permission: "users:read",
  },
  { name: "Ascension Matrix", href: "/ascension", icon: Orbit, permission: "users:read" },

  { name: "SMB Dukaan (Simple)", href: "/smb-dashboard", icon: Zap, permission: "shops:read" },
  { name: "Tenant Network", href: "/tenants", icon: Database, permission: "tenants:manage" },
  { name: "Shop Registry", href: "/shops", icon: Package, permission: "shops:read" },
  {
  ...
  { name: "Treasury Center", href: "/treasury", icon: Wallet, permission: "treasury:read" },
  { name: "Global Tax Ledger", href: "/tax", icon: Calculator, permission: "tax:read" },
  {
  ...
  },
  {
    ...
    href: "/supply-chain",
    icon: Network,
    permission: "supplychain:read",
  },
  { name: "Sourcing Exchange", href: "/sourcing", icon: Factory, permission: "sourcing:read" },
  { name: "Vendor Ecosystem", href: "/vendors", icon: Globe2, permission: "vendors:read" },
  {
  ...
  { name: "Inventory Systems", href: "/inventory", icon: Package, permission: "inventory:read" },
  { name: "OMS Command", href: "/orders", icon: ShoppingCart, permission: "orders:read" },
  { name: "Billing Engine", href: "/billing", icon: Receipt, permission: "billing:read" },
  { name: "Financial Ledger", href: "/ledger", icon: Wallet, permission: "ledger:read" },
  { name: "Audit & Activity", href: "/activity", icon: ShieldCheck, permission: "users:read" },
  { name: "Background Jobs", href: "/jobs", icon: Cpu, permission: "users:read" },
  {
  ...
  },
  {
    ...
    href: "/admin/field-operations-center",
    icon: Pickaxe,
    permission: "fieldops:read",
  },

  // Spatial Command
  { name: "Digital Twin Center", href: "/digital-twin", icon: Box, permission: "users:read" },
  ...
  { name: "Sites", href: "/projects/sites", icon: MapPin, permission: "sites:read", isChild: true },
  {
    name: "Workers",
    href: "/projects/workers",
    icon: UsersIcon,
  ...
  { name: "Users", href: "/users", icon: UsersIcon, permission: "users:read", isChild: true },
  {
    name: "Roles & RBAC",
    href: "/roles",
    icon: ShieldCheck,
  ...
  // Resolution Center
  { name: "Disputes", href: "/disputes", icon: Activity, permission: "users:read" },
];
